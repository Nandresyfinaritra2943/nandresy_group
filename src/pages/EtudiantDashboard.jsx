      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-150px)] p-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg w-96 max-w-full text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Bonjour <strong className="text-gray-800 dark:text-white">{user?.email || "Utilisateur"}</strong> 👋
          </p>
          <p className="text-gray-700 dark:text-gray-400">Vous êtes connecté en tant qu’<b>Étudiant</b>.</p>
          <button
